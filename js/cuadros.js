...
document.write("<a class=\"animacion\" href='"+personaje[i].referencia+"'>");
document.write("<span class=\"capa\" style=\"widht: 100px; height:250px; \"><\/span> ");
document.write("<span class=\"capa-img\" >"+personaje[i].nombre+"<\/span>");
document.write("<\/a>");
document.write("<img src='"+personaje[i].imagen+"'id=\"foto\" style=\"height:250px; widht: 150px\">");
document.write("<\/li>");	
}
