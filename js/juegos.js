...
while(i<8){
	...
	document.write("<a class=\"animacion\" href='"+juego[i].referencia+"'>");
	document.write("<span class=\"capa\"><\/span> ");
	document.write("<span class=\"capa-img\">"+juego[i].titulo+"<\/span>");
	document.write("<\/a>");
	document.write("<img src='"+juego[i].portada+"' style=\"height:300px\">");
	document.write("<\/li>");	
	i++;
}
